...
<table id="dg" title="子级菜单管理" class="easyui-datagrid"
       fitColumns="true" pagination="true" rownumbers="true"
       url="${ctx}/menu/queryMenuByParams?pid=${mid}" fit="true" toolbar="#tb" singleSelect=true> 
    <thead>
    <tr>
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            <tr>
             ...
             <tr>
                <td>菜单url：</td>
                <td> <input type="text" id="menuUrl" name="menuUrl"  /></td>
                
                
            </tr>
            
            <input type="hidden" id="id" name="id" />
            <input type="hidden" id="pid" name="pid" value="${mid}" />
