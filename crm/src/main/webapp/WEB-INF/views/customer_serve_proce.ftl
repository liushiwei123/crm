...
<head>
    ...
    <script type="text/javascript" src="${ctx}/js/customer.serve.proce.js"></script>
</head>
<body style="margin: 1px">
<table id="dg" title="服务分配" class="easyui-datagrid"
       fitColumns="true" pagination="true" rownumbers="true"
       url="${ctx}/customerServe/queryCustomerServeByState?state=100002" fit="true" toolbar="#tb">
    <thead>
    <tr>
...
<div id="tb">
    <div>
        <a href="javascript:openCustomerServeProceDialog()" class="easyui-linkbutton" iconCls="icon-add" plain="true">分配服务</a>
    </div>
   
</div>

<!--分配信息 对话框-->
<div id="dlg" class="easyui-dialog" title="服务分配" closed="true" style="width:900px;height:450px;padding: 10px 20px"
     buttons="#dlg-buttons">
...
<div id="dlg-buttons">
    <a href="javascript:addCustomerServeProce()" class="easyui-linkbutton" iconCls="icon-ok">保存</a>
