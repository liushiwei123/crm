...
<div id="p" class="easyui-panel" title="销售机会信息" style="width: 700px;height: 350px;padding: 10px">
    <table cellspacing="8px">
        ...
        <input type="hidden" id="devResult" name="saleChanceId" value="${saleChance.devResult}"/>
        <tr>
            <td>客户名称：</td>
        ...
        <tr>
            <td>机会描述：</td>
            <td colspan="4">
                <textarea rows="5" cols="50" id="description" name="description" readonly="readonly" value="${saleChance.description?if_exists}"></textarea>
            </td>
        </tr>
        <tr>
            <td>创建人：</td>
...
<div id="toolbar">
        <a href="javascript:$('#dg').edatagrid('addRow')" class="easyui-linkbutton" iconCls="icon-add" plain="true" >添加计划</a>
