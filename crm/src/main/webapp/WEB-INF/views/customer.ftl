...
<table id="dg" title="客户信息管理" class="easyui-datagrid"
       ...
       url="${ctx}/customer/queryCustomerInfoByParams" fit="true" toolbar="#tb">
...
<div id="tb">
	...
	<a href="javascript:openCustomerOtherInfo('联系人管理',1)" class="easyui-linkbutton" iconCls="icon-lxr" plain="true">联系人管理</a>
	<a href="javascript:openCustomerOtherInfo('交往记录管理',2)" class="easyui-linkbutton" iconCls="icon-jwjl" plain="true">交往记录管理</a>
	<a href="javascript:openCustomerOtherInfo('历史订单查看',3)" class="easyui-linkbutton" iconCls="icon-jwjl" plain="true">历史订单查看</a>
</div>
    <div>
    ...
    <form id="fm" method="post">
        ...
        <table cellspacing="8px">
            ...
            <tr>
                <td>客户经理：</td>
                <td>
                    <input class="easyui-combobox" id="cusManager" name="cusManager" data-options="panelHeight:'auto',editable:false,valueField:'trueName',textField:'trueName',url:'${ctx}/user/queryCustomerManager'"/>&nbsp;<font color="red">*</font>
                </td>
                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                <td>客户等级：</td>
                <td>
                    <input class="easyui-combobox" id="level" name="level" data-options="panelHeight:'auto',editable:false,valueField:'dataDicValue',textField:'dataDicValue',url:'${ctx}/dataDic/queryDataDicInfoByDicName?dicName=客户等级'"/>&nbsp;<font color="red">*</font>
                </td>
            </tr>
            <tr>
                <td>客户满意度：</td>
