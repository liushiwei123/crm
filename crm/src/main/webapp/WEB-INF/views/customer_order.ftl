...
<#--客户详情展示-->
<div id="p" class="easyui-panel" title="客户信息" style="width: 700px;height: 350px;padding: 10px">
    <table cellspacing="8px">
        <input type="hidden" id="cid"  value="${customer.id}"/>
        <tr>
            <td>客户名称：</td>
...
<#--开发计划详情记录-->
<table id="dg" title="客户订单记录" class="easyui-datagrid" style="width:700px;height:250px"
       idField="id" pagination="true" rownumbers="true" url="${ctx}/customerOrder/queryCustoemrOrderByCusId?cusId=${customer.id}" fitColumns="true" singleSelect="true">
    <thead>
    <tr>
        <th field="id" width="50">编号</th>
        <th field="orderNo" name="planDate" width="50"  >订单号</th>
        <th field="orderDate" width="100" >订单日期</th>
        <th field="address" width="100" >送货地址</th>
...
<div id="dlg" class="easyui-dialog" style="width:700px;height:450px;padding: 10px 20px"
     closed="true" title="订单详情查看" buttons="#dlg-buttons">
		...
		<br/>
		<table id="dg2" class="easyui-datagrid" title="客户订单详情" style="width:700px;height:250px"
		        pagination="true" rownumbers="true" url="${ctx}/orderDetails/queryOrderDetailsByOid"
		    ...
		    <tr>
		        ...
		        <th field="unit" name="nuit" width="100"  >单位</th>
