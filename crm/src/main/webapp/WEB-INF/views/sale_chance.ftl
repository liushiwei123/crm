...
<table id="dg" title="销售机会信息管理" class="easyui-datagrid"
       ...
       url="${ctx}/saleChance/querySaleChanceByParams" fit="true" toolbar="#tb">
    <thead>
    <tr>
        ...
        <th field="state" width="100" align="center" formatter="formateState" >状态</th>
    </tr>
    </thead>
</table>
<div id="tb">
...
<div id="dlg" class="easyui-dialog" style="width:700px;height:450px;padding: 10px 20px"
    ...
    <form id="fm" method="post">
        <table cellspacing="8px">
            ...
            <tr>
                <td>指派给：</td>
                <td><input class="easyui-combobox" id="assignMan" name="assignMan" data-options="panelHeight:'auto',editable:false,valueField:'trueName',textField:'trueName',url:'${ctx}/user/queryCustomerManager'"/>
                </td>
                <td>    </td>
            </tr>
        </table>
